...
- (UIImage *)addText:(NSString *)textStr font:(UIFont *)font color:(UIColor *)color point:(CGPoint)point
{
    ...
    else
    {
        ...
        [textStr drawAtPoint:point withFont:font];
...
{
    CGSize sizeCountStr = [textStr sizeWithFont:font constrainedToSize:CGSizeMake(MAXFLOAT, MAXFLOAT)];
